...
---
本示例包含TCMDATA中的数据获取、对接clusterprofiler、PPI获取与可视化、韦恩图与upset图
...
## using sankey plot to visualize the relationship between herb, molecule, and target
```{R}
source("TCM_sankey.R")
...
## lollipop_plot
source("gglollipop.R")
gglollipop(x, line.col = "orange", line.type = "dashed")
```
